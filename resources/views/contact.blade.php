...
<div class="row row-cols-1 row-cols-lg-2 mt-3">
    ...
    <div class="col">
        <div>
            ...
            <p class="mb-2">Perumahan GKR, Gg. Anggrek No.G11, Perumahan Puri Bagus, Sadenganmijen, Kec. Krian, Kabupaten Sidoarjo, Jawa Timur 61261</p>
        </div>
        <section class="rounded google-map overflow-hidden shadow p-1" style="min-height: 350px; height: calc(100% - 372px);">
